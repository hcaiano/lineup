...
- Hyper plus U, I, O, P selects workspace 1 through 4. With Include Shift off, physical Shift
  plus the same key moves the focused window to that workspace.
- Hyper plus W, A, X, D focuses up, left, down, right. With Include Shift off, physical Shift plus
  the same key moves the focused window in that direction. With Include Shift on, Hyper plus
  Y, G, B, H moves it up, left, down, right.
