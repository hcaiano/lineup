...
/// - Hyperkey and Hints never had an app, so they get an `AppStyleIcon`.
///
...
enum ToolIconLibrary {
    static func artwork(for id: ToolID) -> NSImage? {
        ...
        default: return nil // Hyperkey, Hints, and any future tool: drawn tile
        }
    }
